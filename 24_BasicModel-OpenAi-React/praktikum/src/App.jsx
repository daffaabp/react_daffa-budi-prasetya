...
function App() {
    ...
    async function generateAnswer(e) {
        ...
        try {
            const promptAwal =
                "kamu adalah seorang customer service bernama Daffa AI, kamu bertugas memberikan rekomendasi judul film yang menarik di tahun 2024. Tanyakan apa yang ingin Anda tonton!";
        ...
        <>
            <div className="bg-white h-screen p-3">
                <h1 className="text-3xl text-center mb-4">
                    Daffa AI Service - Q&A Rekomendasi Film di 2024
                </h1>
