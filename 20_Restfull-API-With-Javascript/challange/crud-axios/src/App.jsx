        ...
        <>
            <div className="container mx-auto p-4">
                ...
                <form onSubmit={handleSubmit} action="post" className="flex flex-col items-center">
                    <input onChange={(e) => {setName(e.target.value);}} type="text" placeholder="Name" className="input input-bordered w-full max-w-xs mb-2" />
                    <input onChange={(e) => {setAge(e.target.value);}} type="number" placeholder="Age" className="input input-bordered w-full max-w-xs mb-2" />
                    <input onChange={(e) => {setAddress(e.target.value);}} type="text" placeholder="Address" className="input input-bordered w-full max-w-xs mb-2" />
                        ...
                        return (
                            <div key={index} className="border p-4 rounded-lg">
                                ...
                                <div className="flex justify-end">
                                    <button className="btn btn-error mr-2" onClick={() => {handleClicks(user.id);}}>Delete</button>
                                </div>
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <form onSubmit={(e) => {handleSubmitEdit(e, user.id);}} className="flex flex-col items-center">
                                        <input onChange={(e) => {setNameEdit(e.target.value);}} type="text" placeholder="Name" className="input input-bordered input-primary w-full max-w-xs my-2" />
                                        <input onChange={(e) => {setAgeEdit(e.target.value);}} type="number" placeholder="Age" className="input input-bordered input-primary w-full max-w-xs my-2" />
                                        <input onChange={(e) => {setAddressEdit(e.target.value);}} type="text" placeholder="Address" className="input input-bordered input-primary w-full max-w-xs my-2" />
