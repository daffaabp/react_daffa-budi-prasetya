...
function App() {
  ...
  // penulisan async await pada arrow function
  ...
  // bentuk dari function biasa
  const fetchData = async () => {
    const response = await axios.get(
      "https://660faeb2356b87a55c520904.mockapi.io/users"
    );
    setData(response.data); // pending karena, data belum datang tapi kita sudah coba untuk menampilkan
